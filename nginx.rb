#
# nginx 1.16.1 + quiche http3 patch
# For more information, see
# https://blog.cloudflare.com/experiment-with-http-3-using-nginx-and-quiche/
#
# This is based on nginx.rb in Homebrew Formula
#
class Nginx< Formula
  desc "HTTP(S) server and reverse proxy, and IMAP/POP3 proxy server with HTTP/3 support"
  ...
  def install
    ...
    system "patch", "-p1", "-i", "quiche/extras/nginx/nginx-1.16.patch"
  ...
  def caveats
    <<~EOS
      ...
      Please refer the following URL for http3 configuration:
      https://blog.cloudflare.com/experiment-with-http-3-using-nginx-and-quiche/
    EOS
  end
